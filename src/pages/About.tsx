        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-foreground mb-6 leading-relaxed">
              Nopex Services is a multi-disciplinary engineering design firm providing Civil, Structural, Architectural, MEP, and Industrial engineering services to clients nationally. We built our practice around a simple idea: the biggest risk on most projects isn't any single discipline — it's the gaps between them.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              By keeping every discipline coordinated through a shared BIM process, we help clients avoid the rework, delays, and cost overruns that come from disconnected engineering teams. Stamped and sealed deliverables are provided through our licensed Professional Engineer (PE) partner network, covering all 50 states.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-4xl">
            Nopex Services provides engineering design, drafting, and BIM coordination. For projects requiring a stamped and sealed submission, we work with a network of licensed Professional Engineers (PEs) covering all 50 states, matched to the state and discipline your project requires.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl">
            This partnership model lets us support projects nationally while ensuring every stamped deliverable is signed off by an engineer licensed in the relevant jurisdiction. We do not perform on-site field services (surveying, on-site inspections, laser scan capture) — these are coordinated with the client's local surveyor/inspector or provided by the client directly.
          </p>
        </div>
      </section>
