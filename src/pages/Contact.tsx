        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-3xl">
              Have an engineering or design project in mind? Get in touch with our team to discuss how we can deliver integrated, BIM-enabled design solutions that ensure your project's success from concept to completion.
            </p>
          </motion.div>
        </div>
      </section>
