  ...
  const expertise = [
    {
      ...
      description: "Our leadership team has been recognized with numerous awards for technical excellence and innovation."
    },
    {
      icon: Briefcase,
      title: "Project Experience",
      stats: "$10B+ Project Value",
      description: "Collective experience managing and delivering billions in infrastructure and building projects."
    },
    {
      icon: GraduationCap,
      title: "Academic Excellence",
      stats: "15 Advanced Degrees",
      description: "Our leaders hold master's degrees and PhDs from top engineering schools worldwide."
    },
    {
      icon: Users2,
      title: "Global Team",
      stats: "200+ Professionals",
      description: "Leading a diverse, multicultural team of engineers and designers across 6 countries."
    }
  ];
