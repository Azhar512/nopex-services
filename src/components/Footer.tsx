      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/about" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">About Us</Link></li>
              <li><Link to="/about/how-we-work" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">How We Work</Link></li>
              <li><Link to="/about/quality-safety" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">Quality & Safety</Link></li>
              <li><Link to="/careers" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">Careers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/projects" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">Projects</Link></li>
              <li><Link to="/insights" className="text-white/80 hover:text-[#a8d96e] transition-colors text-sm">Insights</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              <Link to="/terms-of-use" className="text-white/80 hover:text-[#a8d96e] transition-colors">
                Terms & Conditions
              </Link>
              <span className="text-white/40">|</span>
              <Link to="/privacy-policy" className="text-white/80 hover:text-[#a8d96e] transition-colors">
                Privacy Policy
              </Link>
            </div>
          </div>
